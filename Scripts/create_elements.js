export let data = [];
export let names = ['Риболовка на лотці', 'Зимова рибалка', 'Еко рибалка', 'Спортивна рибалка', 'Браконєрська рибалка'];
const url = "http://127.0.0.1:5000/fishing";
...
export function push_fishing(fishing) {
    const element = document.createElement('div');
    element.classList.add("content_block");
    element.style.display = "flex";
    element.innerHTML = shemaFishingCreate(fishing);
